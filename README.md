...
[![Maven Central](https://img.shields.io/maven-central/v/dm.sent/sent-java)](https://central.sonatype.com/artifact/dm.sent/sent-java/0.20.0)
[![javadoc](https://javadoc.io/badge2/dm.sent/sent-java/0.20.0/javadoc.svg)](https://javadoc.io/doc/dm.sent/sent-java/0.20.0)
...
The REST API documentation can be found on [docs.sent.dm](https://docs.sent.dm). Javadocs are available on [javadoc.io](https://javadoc.io/doc/dm.sent/sent-java/0.20.0).
...
```kotlin
implementation("dm.sent:sent-java:0.20.0")
```

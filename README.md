...
[![Maven Central](https://img.shields.io/maven-central/v/dm.sent/sent-dm-java)](https://central.sonatype.com/artifact/dm.sent/sent-dm-java/0.4.0)
[![javadoc](https://javadoc.io/badge2/dm.sent/sent-dm-java/0.4.0/javadoc.svg)](https://javadoc.io/doc/dm.sent/sent-dm-java/0.4.0)
...
The REST API documentation can be found on [docs.sent.dm](https://docs.sent.dm). Javadocs are available on [javadoc.io](https://javadoc.io/doc/dm.sent/sent-dm-java/0.4.0).
...
```kotlin
implementation("dm.sent:sent-dm-java:0.4.0")
```

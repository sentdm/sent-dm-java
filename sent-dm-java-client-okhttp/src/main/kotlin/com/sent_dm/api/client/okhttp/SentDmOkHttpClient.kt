...
import com.sent_dm.api.client.SentDmClientImpl
...
/**
 * A class that allows building an instance of [SentDmClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class SentDmOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [SentDmClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): SentDmClient = builder().fromEnv().build()
    }

    /** A builder for [SentDmOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [SentDmClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SentDmClient =
            SentDmClientImpl(
                clientOptions
                    .httpClient(

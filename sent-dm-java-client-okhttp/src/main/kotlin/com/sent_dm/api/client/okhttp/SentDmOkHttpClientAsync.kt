...
package com.sent_dm.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.sent_dm.api.client.SentDmClientAsync
import com.sent_dm.api.client.SentDmClientAsyncImpl
import com.sent_dm.api.core.ClientOptions
import com.sent_dm.api.core.Sleeper
import com.sent_dm.api.core.Timeout
import com.sent_dm.api.core.http.Headers
import com.sent_dm.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [SentDmClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class SentDmOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [SentDmClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): SentDmClientAsync = builder().fromEnv().build()
    }

    /** A builder for [SentDmOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.sent_dm.api.core.jsonMapper]. The default is usually sufficient and
         ...
         *
         * Defaults to the production environment: `https://api.sent.dm`.
         */
        ...
        /**
         * Returns an immutable instance of [SentDmClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SentDmClientAsync =
            SentDmClientAsyncImpl(
                clientOptions
                    .httpClient(

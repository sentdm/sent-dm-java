...
class ApiResponseBrandWithKyc
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<BrandWithKyc>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<BrandWithKyc> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<BrandWithKyc> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<BrandWithKyc> = data
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ApiResponseBrandWithKyc]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ApiResponseBrandWithKyc]. */
    class Builder internal constructor() {

        private var data: JsonField<BrandWithKyc> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(apiResponseBrandWithKyc: ApiResponseBrandWithKyc) = apply {
            data = apiResponseBrandWithKyc.data
            error = apiResponseBrandWithKyc.error
            meta = apiResponseBrandWithKyc.meta
            success = apiResponseBrandWithKyc.success
            additionalProperties = apiResponseBrandWithKyc.additionalProperties.toMutableMap()
        }

        /** The response data (null if error) */
        fun data(data: BrandWithKyc?) = data(JsonField.ofNullable(data))

        /** Alias for calling [Builder.data] with `data.orElse(null)`. */
        fun data(data: Optional<BrandWithKyc>) = data(data.getOrNull())

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [BrandWithKyc] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<BrandWithKyc>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [ApiResponseBrandWithKyc].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ApiResponseBrandWithKyc =
            ApiResponseBrandWithKyc(data, error, meta, success, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ApiResponseBrandWithKyc = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiResponseBrandWithKyc &&
            data == other.data &&
            error == other.error &&
            meta == other.meta &&
    ...
    override fun toString() =
        "ApiResponseBrandWithKyc{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

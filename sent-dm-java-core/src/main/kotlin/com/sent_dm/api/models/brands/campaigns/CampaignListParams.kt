...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(campaignListParams: CampaignListParams) = apply {
            brandId = campaignListParams.brandId
        ...
        fun build(): CampaignListParams =
            CampaignListParams(brandId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "CampaignListParams{brandId=$brandId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

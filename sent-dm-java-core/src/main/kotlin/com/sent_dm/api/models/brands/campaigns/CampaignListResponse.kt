...
private constructor(
    private val data: JsonField<List<TcrCampaignWithUseCases>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<TcrCampaignWithUseCases>> = JsonMissing.of(),
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<TcrCampaignWithUseCases>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<TcrCampaignWithUseCases>>? = null
        ...
        /** The response data (null if error) */
        fun data(data: List<TcrCampaignWithUseCases>?) = data(JsonField.ofNullable(data))

        /** Alias for calling [Builder.data] with `data.orElse(null)`. */
        fun data(data: Optional<List<TcrCampaignWithUseCases>>) = data(data.getOrNull())

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<TcrCampaignWithUseCases>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<TcrCampaignWithUseCases>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [TcrCampaignWithUseCases] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: TcrCampaignWithUseCases) = apply {
            this.data =

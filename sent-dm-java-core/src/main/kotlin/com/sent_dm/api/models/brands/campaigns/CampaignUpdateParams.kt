...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(campaignUpdateParams: CampaignUpdateParams) = apply {
            brandId = campaignUpdateParams.brandId
    ...
    override fun toString() =
        "CampaignUpdateParams{brandId=$brandId, campaignId=$campaignId, idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

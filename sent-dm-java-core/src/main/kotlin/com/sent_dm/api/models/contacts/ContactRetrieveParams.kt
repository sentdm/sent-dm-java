...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ContactRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ContactRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ContactRetrieveParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ContactRetrieveParams].
         *

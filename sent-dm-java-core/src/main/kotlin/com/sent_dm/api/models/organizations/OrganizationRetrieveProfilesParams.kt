...
/**
 * Retrieves all sender profiles within an organization that the authenticated user has access to.
 * Returns filtered list based on user's permissions.
 */
...
private constructor(
    ...
    /** A builder for [OrganizationRetrieveProfilesParams]. */

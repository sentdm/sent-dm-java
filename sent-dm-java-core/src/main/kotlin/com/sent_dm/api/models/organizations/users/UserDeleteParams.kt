...
/**
 * Removes a user from an organization or sender profile. Requires admin permissions. This action
 * permanently deletes the user association.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userDeleteParams: UserDeleteParams) = apply {
            customerId = userDeleteParams.customerId
    ...
    override fun toString() =
        "UserDeleteParams{customerId=$customerId, userId=$userId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}

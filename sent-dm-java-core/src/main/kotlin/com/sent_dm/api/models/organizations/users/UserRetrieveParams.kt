...
/**
 * Retrieves a specific user by their ID. Requires appropriate permissions. The customerId can be
 * either an organization ID or a profile ID.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userRetrieveParams: UserRetrieveParams) = apply {
            customerId = userRetrieveParams.customerId
    ...
    override fun hashCode(): Int =
        Objects.hash(customerId, userId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "UserRetrieveParams{customerId=$customerId, userId=$userId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

...
class ApiResponseOfProfileDetail
...
private constructor(
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<ProfileDetail> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ApiResponseOfProfileDetail].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ApiResponseOfProfileDetail]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(apiResponseOfProfileDetail: ApiResponseOfProfileDetail) = apply {
            data = apiResponseOfProfileDetail.data
            error = apiResponseOfProfileDetail.error
            meta = apiResponseOfProfileDetail.meta
            success = apiResponseOfProfileDetail.success
        ...
        fun data(data: Optional<ProfileDetail>) = data(data.getOrNull())

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [ProfileDetail] value instead.
        ...
        /**
         * Returns an immutable instance of [ApiResponseOfProfileDetail].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ApiResponseOfProfileDetail =
    ...
    fun validate(): ApiResponseOfProfileDetail = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiResponseOfProfileDetail &&
            data == other.data &&
            error == other.error &&
            meta == other.meta &&
    ...
    override fun toString() =
        "ApiResponseOfProfileDetail{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

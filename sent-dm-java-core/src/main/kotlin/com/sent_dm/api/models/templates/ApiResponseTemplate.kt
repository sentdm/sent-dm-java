...
private constructor(
    private val data: JsonField<Template>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<Template> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<Template> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<Template> = data
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ApiResponseTemplate]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ApiResponseTemplate]. */
    class Builder internal constructor() {

        private var data: JsonField<Template> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(apiResponseTemplate: ApiResponseTemplate) = apply {
            data = apiResponseTemplate.data
            error = apiResponseTemplate.error
            meta = apiResponseTemplate.meta
            success = apiResponseTemplate.success
            additionalProperties = apiResponseTemplate.additionalProperties.toMutableMap()
        }

        /** The response data (null if error) */
        fun data(data: Template?) = data(JsonField.ofNullable(data))

        /** Alias for calling [Builder.data] with `data.orElse(null)`. */
        fun data(data: Optional<Template>) = data(data.getOrNull())

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [Template] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<Template>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [ApiResponseTemplate].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ApiResponseTemplate =
            ApiResponseTemplate(data, error, meta, success, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ApiResponseTemplate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiResponseTemplate &&
            data == other.data &&
            error == other.error &&
            meta == other.meta &&
    ...
    override fun toString() =
        "ApiResponseTemplate{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

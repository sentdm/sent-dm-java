...
/**
 * A client for interacting with the Sent Dm REST API synchronously. You can also switch to
...
interface SentDmClient {
    ...
    /** A view of [SentDmClient] that provides access to raw HTTP responses for each method. */

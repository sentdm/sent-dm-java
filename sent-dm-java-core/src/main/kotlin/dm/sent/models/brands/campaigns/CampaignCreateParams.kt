...
private constructor(
     ...
     */
    fun campaign(): CampaignData = body.campaign()
     ...
     */
    fun _campaign(): JsonField<CampaignData> = body._campaign()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(campaignCreateParams: CampaignCreateParams) = apply {
            brandId = campaignCreateParams.brandId
            idempotencyKey = campaignCreateParams.idempotencyKey
         ...
         *
         * You should usually call [Builder.campaign] with a well-typed [CampaignData] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun campaign(campaign: JsonField<CampaignData>) = apply { body.campaign(campaign) }
    ...
    /** Request to create a campaign for a brand */
    class Body
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        private val testMode: JsonField<Boolean>,
        private val campaign: JsonField<CampaignData>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            campaign: JsonField<CampaignData> = JsonMissing.of(),
        ) : this(testMode, campaign, mutableMapOf())
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun campaign(): CampaignData = campaign.getRequired("campaign")
        ...
        @JsonProperty("campaign")
        @ExcludeMissing
        fun _campaign(): JsonField<CampaignData> = campaign
        ...
        class Builder internal constructor() {
            ...
            private var campaign: JsonField<CampaignData>? = null
             ...
             * supported value.
             */
            fun campaign(campaign: JsonField<CampaignData>) = apply { this.campaign = campaign }
        ...
        private val hashCode: Int by lazy { Objects.hash(testMode, campaign, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{testMode=$testMode, campaign=$campaign, additionalProperties=$additionalProperties}"
    }
    ...
    override fun hashCode(): Int =
        Objects.hash(brandId, idempotencyKey, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "CampaignCreateParams{brandId=$brandId, idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

...
private constructor(
    private val data: JsonField<Contact>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<Contact> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<Contact> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<Contact> = data
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ApiResponseContact]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ApiResponseContact]. */
    class Builder internal constructor() {

        private var data: JsonField<Contact> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(apiResponseContact: ApiResponseContact) = apply {
            data = apiResponseContact.data
            error = apiResponseContact.error
            meta = apiResponseContact.meta
            success = apiResponseContact.success
            additionalProperties = apiResponseContact.additionalProperties.toMutableMap()
        }

        /** The response data (null if error) */
        fun data(data: Contact?) = data(JsonField.ofNullable(data))

        /** Alias for calling [Builder.data] with `data.orElse(null)`. */
        fun data(data: Optional<Contact>) = data(data.getOrNull())

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [Contact] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<Contact>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [ApiResponseContact].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ApiResponseContact =
            ApiResponseContact(data, error, meta, success, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ApiResponseContact = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiResponseContact &&
            data == other.data &&
            error == other.error &&
            meta == other.meta &&
    ...
    override fun toString() =
        "ApiResponseContact{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

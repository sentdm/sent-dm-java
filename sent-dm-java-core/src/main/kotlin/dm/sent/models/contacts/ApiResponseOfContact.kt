...
private constructor(
     ...
     */
    fun data(): Optional<ContactResponse> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<ContactResponse> = data
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ApiResponseOfContact]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ApiResponseOfContact]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(apiResponseOfContact: ApiResponseOfContact) = apply {
            data = apiResponseOfContact.data
            error = apiResponseOfContact.error
            meta = apiResponseOfContact.meta
            success = apiResponseOfContact.success
            additionalProperties = apiResponseOfContact.additionalProperties.toMutableMap()
        }

        /** The response data (null if error) */
        fun data(data: ContactResponse?) = data(JsonField.ofNullable(data))

        /** Alias for calling [Builder.data] with `data.orElse(null)`. */
        fun data(data: Optional<ContactResponse>) = data(data.getOrNull())

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [ContactResponse] value instead.
        ...
        /**
         * Returns an immutable instance of [ApiResponseOfContact].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ApiResponseOfContact =
            ApiResponseOfContact(data, error, meta, success, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ApiResponseOfContact = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiResponseOfContact &&
            data == other.data &&
            error == other.error &&
            meta == other.meta &&
    ...
    override fun toString() =
        "ApiResponseOfContact{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

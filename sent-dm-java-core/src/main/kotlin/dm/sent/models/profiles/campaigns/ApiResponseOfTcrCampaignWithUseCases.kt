...
class ApiResponseOfTcrCampaignWithUseCases
...
private constructor(
    ...
    /** A builder for [ApiResponseOfTcrCampaignWithUseCases]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = apiResponseOfTcrCampaignWithUseCases.data
            error = apiResponseOfTcrCampaignWithUseCases.error
            meta = apiResponseOfTcrCampaignWithUseCases.meta
            success = apiResponseOfTcrCampaignWithUseCases.success
            additionalProperties =
                apiResponseOfTcrCampaignWithUseCases.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ApiResponseOfTcrCampaignWithUseCases].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ApiResponseOfTcrCampaignWithUseCases =
            ApiResponseOfTcrCampaignWithUseCases(
                data,
                error,
                meta,
    ...
    fun validate(): ApiResponseOfTcrCampaignWithUseCases = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiResponseOfTcrCampaignWithUseCases &&
            data == other.data &&
            error == other.error &&
            meta == other.meta &&
    ...
    override fun toString() =
        "ApiResponseOfTcrCampaignWithUseCases{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

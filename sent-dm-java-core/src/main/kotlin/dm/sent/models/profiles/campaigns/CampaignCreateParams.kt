...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(campaignCreateParams: CampaignCreateParams) = apply {
            profileId = campaignCreateParams.profileId
            idempotencyKey = campaignCreateParams.idempotencyKey
            xProfileId = campaignCreateParams.xProfileId
    ...
    private constructor(
        ...
        ) : this(sandbox, campaign, mutableMapOf())
        ...
        private val hashCode: Int by lazy { Objects.hash(sandbox, campaign, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{sandbox=$sandbox, campaign=$campaign, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "CampaignCreateParams{profileId=$profileId, idempotencyKey=$idempotencyKey, xProfileId=$xProfileId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [TemplateBodyContent]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TemplateBodyContent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(templateBodyContent: TemplateBodyContent) = apply {
            template = templateBodyContent.template
            type = templateBodyContent.type
            variables = templateBodyContent.variables.map { it.toMutableList() }
        ...
        /**
         * Returns an immutable instance of [TemplateBodyContent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TemplateBodyContent =
            TemplateBodyContent(
                template,
                type,
    ...
    fun validate(): TemplateBodyContent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TemplateBodyContent &&
    ...
    override fun toString() =
        "TemplateBodyContent{template=$template, type=$type, variables=$variables, additionalProperties=$additionalProperties}"
}

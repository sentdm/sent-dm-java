...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): WebhookListEventTypesParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [WebhookListEventTypesParams].
         */
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [WebhookListEventTypesParams].
         *

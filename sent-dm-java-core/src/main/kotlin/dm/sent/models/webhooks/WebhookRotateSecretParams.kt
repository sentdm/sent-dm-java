...
private constructor(
    ...
    override fun toString() =
        "WebhookRotateSecretParams{id=$id, idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

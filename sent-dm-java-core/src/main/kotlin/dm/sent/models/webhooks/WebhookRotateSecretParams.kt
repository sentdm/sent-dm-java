...
private constructor(
    ...
    override fun toString() =
        "WebhookRotateSecretParams{id=$id, idempotencyKey=$idempotencyKey, xProfileId=$xProfileId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

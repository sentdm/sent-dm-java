package com.sent_dm.api.core.http

import com.github.tomakehurst.wiremock.client.WireMock.*
import com.github.tomakehurst.wiremock.junit5.WireMockRuntimeInfo
import com.github.tomakehurst.wiremock.junit5.WireMockTest
import com.github.tomakehurst.wiremock.stubbing.Scenario
import com.sent_dm.api.client.okhttp.OkHttpClient
import com.sent_dm.api.core.RequestOptions
import com.sent_dm.api.core.Sleeper
import com.sent_dm.api.errors.SentDmRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw SentDmRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            SentDmRetryableException("Simulated retryable failure")
                        )
                        return future
                    }

...
dependencies {
    testImplementation(project(":sent-dm-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../sent-dm-java-core/src/main/resources/META-INF/proguard/sent-dm-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.sent_dm.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../sent-dm-java-core/src/main/resources/META-INF/proguard/sent-dm-java-core.pro",

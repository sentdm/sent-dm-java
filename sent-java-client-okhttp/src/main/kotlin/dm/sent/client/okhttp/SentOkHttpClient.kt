...
/**
 * A class that allows building an instance of [SentClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class SentOkHttpClient private constructor() {
    ...
    companion object {
         ...
         */
        @JvmStatic fun fromEnv(): SentClient = builder().fromEnv().build()
    }

    /** A builder for [SentOkHttpClient]. */

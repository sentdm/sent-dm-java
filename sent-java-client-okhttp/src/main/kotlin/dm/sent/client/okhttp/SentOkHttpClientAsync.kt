...
/**
 * A class that allows building an instance of [SentClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class SentOkHttpClientAsync private constructor() {
    ...
    companion object {
         ...
         */
        @JvmStatic fun fromEnv(): SentClientAsync = builder().fromEnv().build()
    }

    /** A builder for [SentOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [SentClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SentClientAsync =
            SentClientAsyncImpl(
                clientOptions
                    .httpClient(

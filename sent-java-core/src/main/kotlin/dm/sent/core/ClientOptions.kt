...
private constructor(
     ...
     *
     * Use the one published in `sent-java-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [dm.sent.core.jsonMapper]. The default is usually sufficient and rarely needs to
     * be overridden.
     */
                            ...
                            object : ThreadFactory {
                                ...
                                override fun newThread(runnable: Runnable): Thread =
                                    threadFactory.newThread(runnable).also {
                                        it.name =
                                            "sent-stream-handler-thread-${count.getAndIncrement()}"
                                    }
                            }
                        )
                    )

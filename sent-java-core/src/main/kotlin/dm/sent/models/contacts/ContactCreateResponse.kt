...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(contactCreateResponse: ContactCreateResponse) = apply {
            ...
            error = contactCreateResponse.error
            meta = contactCreateResponse.meta
            success = contactCreateResponse.success
        ...
        fun build(): ContactCreateResponse =
            ContactCreateResponse(data, error, meta, success, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "ContactCreateResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

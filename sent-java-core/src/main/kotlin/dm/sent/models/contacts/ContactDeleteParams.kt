...
/**
 * **Deprecated.** Use `PATCH /v3/contacts/{id}` with `{"opt_out": true}` instead, and expect this
 * to be removed in a future release. It still behaves exactly as before, so nothing needs to change
 * today.
 *
 ...
 * history along with the contact, which is the part you need if anyone ever asks why you stopped,
 * or why you started again.
 *
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(contactDeleteParams: ContactDeleteParams) = apply {
            ...
            mutationRequest = contactDeleteParams.mutationRequest
    ...
    override fun hashCode(): Int =
        Objects.hash(id, xProfileId, mutationRequest, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ContactDeleteParams{id=$id, xProfileId=$xProfileId, mutationRequest=$mutationRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

...
private constructor(
    ...
    /**
     * Always false. Contacts are no longer shared or inherited between sender profiles — a profile
     * sees only the contacts it owns. Retained so existing v3 clients reading is_inherited keep
    ...
    class Builder internal constructor() {
        ...
        internal fun from(contactResponse: ContactResponse) = apply {
            ...
            customerId = contactResponse.customerId

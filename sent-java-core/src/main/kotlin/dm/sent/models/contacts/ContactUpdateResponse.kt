...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ContactUpdateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ContactUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contactUpdateResponse: ContactUpdateResponse) = apply {
            data = contactUpdateResponse.data
            error = contactUpdateResponse.error
            meta = contactUpdateResponse.meta
            success = contactUpdateResponse.success
            additionalProperties = contactUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ContactUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ContactUpdateResponse =
            ContactUpdateResponse(data, error, meta, success, additionalProperties.toMutableMap())
    }
     ...
     *   type.
     */
    fun validate(): ContactUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        /**
         * Always false. Contacts are no longer shared or inherited between sender profiles — a
         * profile sees only the contacts it owns. Retained so existing v3 clients reading
        ...
        override fun toString() =
            "Data{id=$id, availableChannels=$availableChannels, countryCode=$countryCode, createdAt=$createdAt, customerId=$customerId, defaultChannel=$defaultChannel, formatE164=$formatE164, formatInternational=$formatInternational, formatNational=$formatNational, formatRfc=$formatRfc, isInherited=$isInherited, optOut=$optOut, phoneNumber=$phoneNumber, regionCode=$regionCode, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContactUpdateResponse &&
            data == other.data &&
            error == other.error &&
            meta == other.meta &&
    ...
    override fun toString() =
        "ContactUpdateResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

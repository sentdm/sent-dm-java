...
class ConversationListMessagesResponse
...
private constructor(
    ...
    /** A builder for [ConversationListMessagesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conversationListMessagesResponse: ConversationListMessagesResponse) =
            apply {
                data = conversationListMessagesResponse.data
                error = conversationListMessagesResponse.error
                meta = conversationListMessagesResponse.meta
                success = conversationListMessagesResponse.success
                additionalProperties =
                    conversationListMessagesResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ConversationListMessagesResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConversationListMessagesResponse =
            ConversationListMessagesResponse(
                data,
                error,
                meta,
     ...
     *   type.
     */
    fun validate(): ConversationListMessagesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(messages, pagination, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                messages = data.messages.map { it.toMutableList() }
        ...
        private constructor(
             ...
             *   the server responded with an unexpected value).
             */
            fun templateCategory(): Optional<String> =
                templateCategory.getOptional("template_category")
             ...
             *
             * Unlike [messageBody], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("message_body")
            @ExcludeMissing
             ...
             *
             * Unlike [templateCategory], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("template_category")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                internal fun from(message: Message) = apply {
                    id = message.id
                    activeContactPrice = message.activeContactPrice
                    channel = message.channel
                    contactId = message.contactId
                    createdAt = message.createdAt
                    customerId = message.customerId
                    direction = message.direction
                    events = message.events.map { it.toMutableList() }
                 ...
                 *
                 * You should usually call [Builder.activeContactPrice] with a well-typed [Double]
                 ...
                 *
                 * You should usually call [Builder.messageBody] with a well-typed [MessageBody]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.phoneInternational] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                ...
                /**
                 * Alias for calling [Builder.templateCategory] with
                 * `templateCategory.orElse(null)`.
                 */
                 ...
                 *
                 * You should usually call [Builder.templateCategory] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    ) : this(postbackData, text, type, value, mutableMapOf())

                    /**
                     * @throws SentInvalidDataException if the JSON field has an unexpected type
                     *   (e.g. if the server responded with an unexpected value).
                     */
                    fun postbackData(): Optional<String> = postbackData.getOptional("postbackData")
                     ...
                     *
                     * Unlike [postbackData], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("postbackData")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                        ...
                        internal fun from(button: Button) = apply {
                            postbackData = button.postbackData
                            text = button.text
                            type = button.type
                            value = button.value
                        ...
                        fun postbackData(postbackData: String?) =
                            postbackData(JsonField.ofNullable(postbackData))

                        /**
                         * Alias for calling [Builder.postbackData] with
                         * `postbackData.orElse(null)`.
                         */
                        fun postbackData(postbackData: Optional<String>) =
                            postbackData(postbackData.getOrNull())

                        /**
                         * Sets [Builder.postbackData] to an arbitrary JSON value.
                         *
                         * You should usually call [Builder.postbackData] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                    ...
                    private val hashCode: Int by lazy {
                        Objects.hash(postbackData, text, type, value, additionalProperties)
                    }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(messages, pagination, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{messages=$messages, pagination=$pagination, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConversationListMessagesResponse &&
            data == other.data &&
            error == other.error &&
            meta == other.meta &&
    ...
    override fun toString() =
        "ConversationListMessagesResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

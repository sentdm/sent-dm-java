...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(conversationListParams: ConversationListParams) = apply {
            page = conversationListParams.page
            pageSize = conversationListParams.pageSize
            xProfileId = conversationListParams.xProfileId
    ...
    override fun hashCode(): Int =
        Objects.hash(page, pageSize, xProfileId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ConversationListParams{page=$page, pageSize=$pageSize, xProfileId=$xProfileId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

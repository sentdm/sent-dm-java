...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(conversationListResponse: ConversationListResponse) = apply {
            ...
            error = conversationListResponse.error
            meta = conversationListResponse.meta
            success = conversationListResponse.success
    ...
    override fun toString() =
        "ConversationListResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

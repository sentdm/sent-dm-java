...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(profileCreateResponse: ProfileCreateResponse) = apply {
            ...
            error = profileCreateResponse.error
            meta = profileCreateResponse.meta
            success = profileCreateResponse.success
        ...
        fun build(): ProfileCreateResponse =
            ProfileCreateResponse(data, error, meta, success, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "ProfileCreateResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

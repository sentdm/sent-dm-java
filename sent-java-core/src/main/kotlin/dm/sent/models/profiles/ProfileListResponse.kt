        ...
        private constructor(
            ...
            private constructor(
                ...
                private constructor(
                     ...
                     *   (e.g. if the server responded with an unexpected value).
                     */
                    fun brandRelationship(): Optional<BrandRelationship> =
                     ...
                     *   (e.g. if the server responded with an unexpected value).
                     */
                    fun vertical(): Optional<Vertical> = vertical.getOptional("vertical")
                     ...
                     *
                     * Unlike [expectedMessagingVolume], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("expected_messaging_volume")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                        ...
                        private var brandRelationship: JsonField<BrandRelationship> =
                            JsonMissing.of()
                        ...
                        private var vertical: JsonField<Vertical> = JsonMissing.of()
                        private var additionalProperties: MutableMap<String, JsonValue> =
                            mutableMapOf()
                         ...
                         */
                        fun brandRelationship(brandRelationship: Optional<BrandRelationship>) =
                         ...
                         * [BrandRelationship] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                        fun brandRelationship(brandRelationship: JsonField<BrandRelationship>) =
                            apply {
                         ...
                         *
                         * You should usually call [Builder.expectedMessagingVolume] with a
                         * well-typed [String] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                        fun expectedMessagingVolume(expectedMessagingVolume: JsonField<String>) =
                            apply {
                        ...
                        fun vertical(vertical: Vertical?) = vertical(JsonField.ofNullable(vertical))

                        /** Alias for calling [Builder.vertical] with `vertical.orElse(null)`. */
                        fun vertical(vertical: Optional<Vertical>) = vertical(vertical.getOrNull())

                        /**
                         * Sets [Builder.vertical] to an arbitrary JSON value.
                         *
                         * You should usually call [Builder.vertical] with a well-typed [Vertical]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        fun vertical(vertical: JsonField<Vertical>) = apply {
                    ...
                    private constructor(private val value: JsonField<String>) : Enum {
                        ...
                        companion object {
                            ...
                            @JvmStatic
                            fun of(value: String) = BrandRelationship(JsonField.of(value))
                        }
                        ...
                        /**
                         * An enum containing [BrandRelationship]'s known values, as well as an
                         * [_UNKNOWN] member.
                         *
                         * An instance of [BrandRelationship] can contain an unknown value in a
                         * couple of cases:
                        ...
                        enum class Value {
                            ...
                            KEY_ACCOUNT,
                            /**
                             * An enum member indicating that [BrandRelationship] was instantiated
                         ...
                         *
                         * @throws SentInvalidDataException if this class instance's value is a not
                         *   a known member.
                         */
                        fun known(): Known =
                            when (this) {
                                ...
                                KEY_ACCOUNT -> Known.KEY_ACCOUNT
                                    ...
                                    throw SentInvalidDataException(
                                        "Unknown BrandRelationship: $value"
                                    )
                            }
                         ...
                         *
                         * @throws SentInvalidDataException if this class instance's value does not
                    ...
                    private constructor(
                         ...
                         *
                         * Unlike [isMain], this method doesn't throw if the JSON field has an
                         * unexpected type.
                         */
                        @JsonProperty("isMain")
                        @ExcludeMissing
                        fun _isMain(): JsonField<Boolean> = isMain
                        ...
                        class Builder internal constructor() {
                             ...
                             *
                             * You should usually call [Builder.isMain] with a well-typed [Boolean]
                             * value instead. This method is primarily for setting the field to an
                             * undocumented or not yet supported value.
                             */
                        ...
                        private val hashCode: Int by lazy {
                            Objects.hash(id, isMain, additionalProperties)
                        }
                    ...
                    private constructor(private val value: JsonField<String>) : Enum {
                        ...
                        /**
                         * An enum containing [Vertical]'s known values, as well as an [_UNKNOWN]
                         * member.
                         *
                         * An instance of [Vertical] can contain an unknown value in a couple of
                         * cases:
                         * - It was deserialized from data that doesn't match any known member. For
                         *   example, if the SDK is on an older version than the API, then the API
                         *   may respond with new members that the SDK is unaware of.
                        ...
                        enum class Value {
                            ...
                            COMMUNICATION,
                            /**
                             * An enum member indicating that [Vertical] was instantiated with an
                             * unknown value.
                             */
                            _UNKNOWN,
                        }

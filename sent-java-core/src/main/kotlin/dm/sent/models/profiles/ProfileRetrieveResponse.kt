    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                 ...
                 *
                 * Unlike [expectedMessagingVolume], this method doesn't throw if the JSON field has
                 * an unexpected type.
                 */
                @JsonProperty("expected_messaging_volume")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                    ...
                    private var brandRelationship: JsonField<BrandRelationship> = JsonMissing.of()
                     ...
                     * [BrandRelationship] value instead. This method is primarily for setting the
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                     ...
                     * [_UNKNOWN] member.
                     *
                     * An instance of [BrandRelationship] can contain an unknown value in a couple
                     * of cases:
                    ...
                    enum class Value {
                        ...
                        KEY_ACCOUNT,
                        /**
                         * An enum member indicating that [BrandRelationship] was instantiated with
                         * an unknown value.
                         */
                        _UNKNOWN,
                    }
                    ...
                    fun known(): Known =
                        when (this) {
                            ...
                            KEY_ACCOUNT -> Known.KEY_ACCOUNT
                                ...
                                throw SentInvalidDataException("Unknown BrandRelationship: $value")
                        }

...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(profileRetrieveResponse: ProfileRetrieveResponse) = apply {
            ...
            error = profileRetrieveResponse.error
            meta = profileRetrieveResponse.meta
            success = profileRetrieveResponse.success
        ...
        fun build(): ProfileRetrieveResponse =
            ProfileRetrieveResponse(data, error, meta, success, additionalProperties.toMutableMap())
    }
    ...
    private constructor(
        ...
        /**
         * Always false. A profile no longer shares contacts with sibling profiles — it sees only
         * what it owns. Retained so existing v3 clients reading allow_contact_sharing keep
        ...
        /**
         * Deprecated. Always null. Sender borrowing is gone: a profile no longer points at another
         * profile for its SMS sender, and every profile owns the sender it sends from.
         *
         * Kept on the wire, and never populated, because those are two different promises. Removing
         * the key changes the response's shape — a generated client loses the property and stops
         * compiling on the next regenerate, for a value that is now null for every profile in
         * existence. Keeping it null costs a key and breaks nobody, and null is the honest answer
         * rather than a placeholder: there is no borrowing left to report.
         *
         ...
         * borrower-to-lender pairing is not recoverable. The only surviving trace is a notes string
         * on the copied row.
         *
         * @throws SentInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                id = data.id
                allowContactSharing = data.allowContactSharing
                allowNumberChangeDuringOnboarding = data.allowNumberChangeDuringOnboarding
                allowTemplateSharing = data.allowTemplateSharing
                ...
                email = data.email
                icon = data.icon
                inheritContacts = data.inheritContacts
                inheritTcrBrand = data.inheritTcrBrand
                inheritTcrCampaign = data.inheritTcrCampaign
                inheritTemplates = data.inheritTemplates
                name = data.name
                organizationId = data.organizationId
                sendingPhoneNumber = data.sendingPhoneNumber
                sendingPhoneNumberProfileId = data.sendingPhoneNumberProfileId
                sendingWhatsappNumberProfileId = data.sendingWhatsappNumberProfileId
        ...
        private constructor(
             ...
             *
             * Unlike [compliance], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("compliance")
            @ExcludeMissing
             ...
             *
             * Unlike [tcrBrandId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("tcr_brand_id")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 * [IdentityStatus] value instead. This method is primarily for setting the field to
            ...
            private constructor(
                 ...
                 *
                 * Unlike [countryOfRegistration], this method doesn't throw if the JSON field has
                 * an unexpected type.
                 */
                @JsonProperty("country_of_registration")
                @ExcludeMissing
            ...
            private constructor(
                 ...
                 * reached neither TCR nor any decision, and its column is dropped with no backfill,
                 * because the values were prose and the typed equivalent is the campaign's
                 * MessagingUseCaseUS.
                 *
                ...
                class Builder internal constructor() {
                    ...
                    private var brandRelationship: JsonField<TcrBrandRelationship> =
                        JsonMissing.of()
                    private var destinationCountries: JsonField<MutableList<DestinationCountry>>? =
                        null
                     ...
                     * [TcrBrandRelationship] value instead. This method is primarily for setting
                     ...
                     *
                     * You should usually call [Builder.primaryUseCase] with a well-typed [String]
                     ...
                     *
                     * You should usually call [Builder.vertical] with a well-typed [TcrVertical]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
    ...
    override fun toString() =
        "ProfileRetrieveResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

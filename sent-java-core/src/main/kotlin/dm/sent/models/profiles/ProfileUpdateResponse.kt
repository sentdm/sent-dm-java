...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ProfileUpdateResponse =
            ProfileUpdateResponse(data, error, meta, success, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "ProfileUpdateResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

...
class TcrBrandRelationship @JsonCreator private constructor(private val value: JsonField<String>) :
    ...
    fun known(): Known =
        when (this) {
            ...
            else -> throw SentInvalidDataException("Unknown TcrBrandRelationship: $value")
        }
     ...
     *
     * @throws SentInvalidDataException if this class instance's value does not have the expected
     *   primitive type.
     */
    fun asString(): String =

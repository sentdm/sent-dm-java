...
class ApiResponseOfBrandCampaign
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<BrandCampaign>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<BrandCampaign> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<BrandCampaign> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<BrandCampaign> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ApiResponseOfBrandCampaign].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ApiResponseOfBrandCampaign]. */
    class Builder internal constructor() {

        private var data: JsonField<BrandCampaign> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(apiResponseOfBrandCampaign: ApiResponseOfBrandCampaign) = apply {
            data = apiResponseOfBrandCampaign.data
            error = apiResponseOfBrandCampaign.error
            meta = apiResponseOfBrandCampaign.meta
            success = apiResponseOfBrandCampaign.success
            additionalProperties = apiResponseOfBrandCampaign.additionalProperties.toMutableMap()
        }

        /** A 10DLC campaign registered for a brand. */
        fun data(data: BrandCampaign?) = data(JsonField.ofNullable(data))

        /** Alias for calling [Builder.data] with `data.orElse(null)`. */
        fun data(data: Optional<BrandCampaign>) = data(data.getOrNull())

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [BrandCampaign] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<BrandCampaign>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [ApiResponseOfBrandCampaign].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ApiResponseOfBrandCampaign =
     ...
     *   type.
     */
    fun validate(): ApiResponseOfBrandCampaign = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiResponseOfBrandCampaign &&
            data == other.data &&
            error == other.error &&
            meta == other.meta &&
    ...
    override fun toString() =
        "ApiResponseOfBrandCampaign{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

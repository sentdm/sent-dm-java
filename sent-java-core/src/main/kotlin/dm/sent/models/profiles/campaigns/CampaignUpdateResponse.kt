...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CampaignUpdateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CampaignUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(campaignUpdateResponse: CampaignUpdateResponse) = apply {
            data = campaignUpdateResponse.data
            error = campaignUpdateResponse.error
            meta = campaignUpdateResponse.meta
            success = campaignUpdateResponse.success
            additionalProperties = campaignUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CampaignUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CampaignUpdateResponse =
            CampaignUpdateResponse(data, error, meta, success, additionalProperties.toMutableMap())
    }
     ...
     *   type.
     */
    fun validate(): CampaignUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                hasSubmissionTransaction = data.hasSubmissionTransaction
             ...
             *
             * You should usually call [Builder.hasSubmissionTransaction] with a well-typed
            ...
            /**
             * Expected messaging volume for this campaign — customer-supplied on create/update, and
             * the input to both the TCR usecase classification (LOW_VOLUME vs MIXED/specific) and
             * the campaign fee tier. Surfaced so customers can read back the value they set.
             */
             ...
             *
             * You should usually call [Builder.volume] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        /**
         * Customer-facing use-case representation for the public v3 campaign contract. Exists for
         * the same reason as BrandCampaignV3Response: nesting the TcrCampaignUseCase database
         * entity in a public response means any column added to that table silently becomes part of
         * the customer-facing contract. This DTO is an explicit allowlist, so a new column stays
         * invisible until it is added here on purpose. This mirrors exactly the fields the entity
         * already serialized, so it removes nothing from the current response shape. It only closes
         * the future-leak path.
         */
        class UseCase
        @JsonCreator(mode = JsonCreator.Mode.DISABLED)
        private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CampaignUpdateResponse &&
            data == other.data &&
            error == other.error &&
            meta == other.meta &&
    ...
    override fun toString() =
        "CampaignUpdateResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

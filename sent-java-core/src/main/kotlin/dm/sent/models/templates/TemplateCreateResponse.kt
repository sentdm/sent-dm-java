...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(templateCreateResponse: TemplateCreateResponse) = apply {
            ...
            error = templateCreateResponse.error
            meta = templateCreateResponse.meta
            success = templateCreateResponse.success
        ...
        fun build(): TemplateCreateResponse =
            TemplateCreateResponse(data, error, meta, success, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "TemplateCreateResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun definition(definition: Optional<Definition>) = definition(definition.getOrNull())
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Complete definition of a message template including header, body, footer, and buttons
             */
            fun definition(definition: Definition?) = definition(JsonField.ofNullable(definition))

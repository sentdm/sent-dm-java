...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [TemplateUpdateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TemplateUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(templateUpdateResponse: TemplateUpdateResponse) = apply {
            data = templateUpdateResponse.data
            error = templateUpdateResponse.error
            meta = templateUpdateResponse.meta
            success = templateUpdateResponse.success
            additionalProperties = templateUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TemplateUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TemplateUpdateResponse =
            TemplateUpdateResponse(data, error, meta, success, additionalProperties.toMutableMap())
    }
     ...
     *   type.
     */
    fun validate(): TemplateUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        override fun toString() =
            "Data{customerId=$customerId, id=$id, category=$category, channels=$channels, createdAt=$createdAt, isPublished=$isPublished, language=$language, name=$name, status=$status, updatedAt=$updatedAt, variables=$variables, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TemplateUpdateResponse &&
            data == other.data &&
            error == other.error &&
            meta == other.meta &&
    ...
    override fun toString() =
        "TemplateUpdateResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

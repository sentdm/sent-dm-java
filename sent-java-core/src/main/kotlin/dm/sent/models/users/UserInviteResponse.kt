...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [UserInviteResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UserInviteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userInviteResponse: UserInviteResponse) = apply {
            data = userInviteResponse.data
            error = userInviteResponse.error
            meta = userInviteResponse.meta
            success = userInviteResponse.success
            additionalProperties = userInviteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserInviteResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UserInviteResponse =
            UserInviteResponse(data, error, meta, success, additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserInviteResponse &&
            data == other.data &&
            error == other.error &&
            meta == other.meta &&
    ...
    override fun toString() =
        "UserInviteResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

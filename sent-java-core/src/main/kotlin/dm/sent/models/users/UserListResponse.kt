    ...
    private constructor(
        ...
        private constructor(
            ...
            override fun toString() =
                "User{id=$id, createdAt=$createdAt, email=$email, invitedAt=$invitedAt, lastLoginAt=$lastLoginAt, name=$name, role=$role, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
        }

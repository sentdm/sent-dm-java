...
private constructor(
    ...
    override fun toString() =
        "UserResponse{id=$id, createdAt=$createdAt, customerId=$customerId, email=$email, invitedAt=$invitedAt, lastLoginAt=$lastLoginAt, name=$name, role=$role, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}

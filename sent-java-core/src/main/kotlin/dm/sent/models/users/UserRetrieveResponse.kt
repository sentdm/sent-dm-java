...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userRetrieveResponse: UserRetrieveResponse) = apply {
            ...
            error = userRetrieveResponse.error
            meta = userRetrieveResponse.meta
            success = userRetrieveResponse.success
        ...
        fun build(): UserRetrieveResponse =
            UserRetrieveResponse(data, error, meta, success, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "UserRetrieveResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

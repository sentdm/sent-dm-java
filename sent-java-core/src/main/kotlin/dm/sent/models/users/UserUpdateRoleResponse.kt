...
private constructor(
    ...
    /** A builder for [UserUpdateRoleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userUpdateRoleResponse: UserUpdateRoleResponse) = apply {
            data = userUpdateRoleResponse.data
            error = userUpdateRoleResponse.error
            meta = userUpdateRoleResponse.meta
            success = userUpdateRoleResponse.success
            additionalProperties = userUpdateRoleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserUpdateRoleResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UserUpdateRoleResponse =
            UserUpdateRoleResponse(data, error, meta, success, additionalProperties.toMutableMap())
    }
     ...
     *   type.
     */
    fun validate(): UserUpdateRoleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        override fun toString() =
            "Data{id=$id, createdAt=$createdAt, customerId=$customerId, email=$email, invitedAt=$invitedAt, lastLoginAt=$lastLoginAt, name=$name, role=$role, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserUpdateRoleResponse &&
            data == other.data &&
            error == other.error &&
            meta == other.meta &&
    ...
    override fun toString() =
        "UserUpdateRoleResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Body of an outbound message lifecycle event. Delivered once per status change, so a
         * single message produces several of these as it moves toward a terminal status.
         */
        fun payload(payload: MessageEventPayload?) = payload(JsonField.ofNullable(payload))

        /** Alias for calling [Builder.payload] with `payload.orElse(null)`. */
        fun payload(payload: Optional<MessageEventPayload>) = payload(payload.getOrNull())

        /**
         * Sets [Builder.payload] to an arbitrary JSON value.
         *
         * You should usually call [Builder.payload] with a well-typed [MessageEventPayload] value

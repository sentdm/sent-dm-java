...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(templateEvent: TemplateEvent) = apply {
            ...
            requestId = templateEvent.requestId
    ...
    override fun toString() =
        "TemplateEvent{event=$event, field=$field, payload=$payload, requestId=$requestId, timestamp=$timestamp, additionalProperties=$additionalProperties}"
}

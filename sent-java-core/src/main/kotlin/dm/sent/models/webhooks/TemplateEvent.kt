...
private constructor(
    ...
    private val payload: JsonField<TemplateEventPayload>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        payload: JsonField<TemplateEventPayload> = JsonMissing.of(),
    ...
    /**
     * Body of a template status event. Delivered when a template's review outcome changes, so you
     * can react without polling.
     *
     * @throws SentInvalidDataException if the JSON field has an unexpected type (e.g. if the server
     *   responded with an unexpected value).
     */
    fun payload(): Optional<TemplateEventPayload> = payload.getOptional("payload")
    ...
    @JsonProperty("payload")
    @ExcludeMissing
    fun _payload(): JsonField<TemplateEventPayload> = payload
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [TemplateEvent]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TemplateEvent]. */
    class Builder internal constructor() {

        private var event: JsonField<String> = JsonMissing.of()
        private var field: JsonField<String> = JsonMissing.of()
        private var payload: JsonField<TemplateEventPayload> = JsonMissing.of()
        private var timestamp: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(templateEvent: TemplateEvent) = apply {
            event = templateEvent.event
            field = templateEvent.field
            payload = templateEvent.payload
            timestamp = templateEvent.timestamp
            additionalProperties = templateEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Body of a template status event. Delivered when a template's review outcome changes, so
         * you can react without polling.
         */
        fun payload(payload: TemplateEventPayload?) = payload(JsonField.ofNullable(payload))

        /** Alias for calling [Builder.payload] with `payload.orElse(null)`. */
        fun payload(payload: Optional<TemplateEventPayload>) = payload(payload.getOrNull())

        /**
         * Sets [Builder.payload] to an arbitrary JSON value.
         *
         * You should usually call [Builder.payload] with a well-typed [TemplateEventPayload] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun payload(payload: JsonField<TemplateEventPayload>) = apply { this.payload = payload }
        ...
        /**
         * Returns an immutable instance of [TemplateEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TemplateEvent =
            TemplateEvent(event, field, payload, timestamp, additionalProperties.toMutableMap())
    }
     ...
     *   type.
     */
    fun validate(): TemplateEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "TemplateEvent{event=$event, field=$field, payload=$payload, timestamp=$timestamp, additionalProperties=$additionalProperties}"
}

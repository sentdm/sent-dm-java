...
private constructor(
    ...
    fun webhooks(): Optional<List<WebhookResponse>> = data().flatMap { it.webhooks() }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookListPageResponse: WebhookListPageResponse) = apply {
            data = webhookListPageResponse.data
            error = webhookListPageResponse.error
            meta = webhookListPageResponse.meta
            success = webhookListPageResponse.success
        ...
        fun build(): WebhookListPageResponse =
            WebhookListPageResponse(data, error, meta, success, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "WebhookListPageResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

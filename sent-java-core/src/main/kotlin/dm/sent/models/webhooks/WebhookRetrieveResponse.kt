...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookRetrieveResponse: WebhookRetrieveResponse) = apply {
            ...
            error = webhookRetrieveResponse.error
            meta = webhookRetrieveResponse.meta
            success = webhookRetrieveResponse.success
        ...
        fun build(): WebhookRetrieveResponse =
            WebhookRetrieveResponse(data, error, meta, success, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "WebhookRetrieveResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

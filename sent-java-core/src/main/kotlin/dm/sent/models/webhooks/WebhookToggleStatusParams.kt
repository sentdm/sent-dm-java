...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookToggleStatusParams: WebhookToggleStatusParams) = apply {
            ...
            xProfileId = webhookToggleStatusParams.xProfileId
    ...
    override fun toString() =
        "WebhookToggleStatusParams{id=$id, idempotencyKey=$idempotencyKey, xProfileId=$xProfileId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

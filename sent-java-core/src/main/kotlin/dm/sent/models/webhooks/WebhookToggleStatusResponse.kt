...
private constructor(
    ...
    /** A builder for [WebhookToggleStatusResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(webhookToggleStatusResponse: WebhookToggleStatusResponse) = apply {
            data = webhookToggleStatusResponse.data
            error = webhookToggleStatusResponse.error
            meta = webhookToggleStatusResponse.meta
            success = webhookToggleStatusResponse.success
            additionalProperties = webhookToggleStatusResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WebhookToggleStatusResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WebhookToggleStatusResponse =
     ...
     *   type.
     */
    fun validate(): WebhookToggleStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookToggleStatusResponse &&
            data == other.data &&
            error == other.error &&
            meta == other.meta &&
    ...
    override fun toString() =
        "WebhookToggleStatusResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

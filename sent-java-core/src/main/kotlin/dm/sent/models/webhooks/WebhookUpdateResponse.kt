...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookUpdateResponse: WebhookUpdateResponse) = apply {
            ...
            error = webhookUpdateResponse.error
            meta = webhookUpdateResponse.meta
            success = webhookUpdateResponse.success
        ...
        fun build(): WebhookUpdateResponse =
            WebhookUpdateResponse(data, error, meta, success, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "WebhookUpdateResponse{data=$data, error=$error, meta=$meta, success=$success, additionalProperties=$additionalProperties}"
}

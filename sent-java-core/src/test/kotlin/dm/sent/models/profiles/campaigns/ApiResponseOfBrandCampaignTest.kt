...
internal class ApiResponseOfBrandCampaignTest {

    @Test
    fun create() {
        val apiResponseOfBrandCampaign =
            ApiResponseOfBrandCampaign.builder()
                .data(
        ...
        assertThat(apiResponseOfBrandCampaign.data())
            .contains(
                BrandCampaign.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .billedDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(apiResponseOfBrandCampaign.error())
            .contains(
                ErrorDetail.builder()
                    .code("code")
                    .details(
        ...
        assertThat(apiResponseOfBrandCampaign.meta())
            .contains(
                ApiMeta.builder()
                    .requestId("request_id")
                    .timestamp(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(apiResponseOfBrandCampaign.success()).contains(true)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedApiResponseOfBrandCampaign =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(apiResponseOfBrandCampaign),
                jacksonTypeRef<ApiResponseOfBrandCampaign>(),
            )

        assertThat(roundtrippedApiResponseOfBrandCampaign).isEqualTo(apiResponseOfBrandCampaign)
    }
}

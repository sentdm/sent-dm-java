    ...
    fun create() {
        val templateRetrieveResponse =
            TemplateRetrieveResponse.builder()
                .data(
                    TemplateRetrieveResponse.Data.builder()
                ...
                .error(
                    TemplateRetrieveResponse.Error.builder()
                        .code("code")
                        .details(
                            TemplateRetrieveResponse.Error.Details.builder()
                ...
                .meta(
                    TemplateRetrieveResponse.Meta.builder()
        ...
        assertThat(templateRetrieveResponse.data())
            .contains(
                TemplateRetrieveResponse.Data.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .category("category")
        ...
        assertThat(templateRetrieveResponse.error())
            .contains(
                TemplateRetrieveResponse.Error.builder()
                    .code("code")
                    .details(
        ...
        assertThat(templateRetrieveResponse.meta())
            .contains(
                TemplateRetrieveResponse.Meta.builder()
                    .requestId("request_id")
                    .timestamp(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(templateRetrieveResponse.success()).contains(true)
    }

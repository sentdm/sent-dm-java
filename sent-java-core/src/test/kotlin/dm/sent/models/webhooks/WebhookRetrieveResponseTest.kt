    ...
    fun create() {
        val webhookRetrieveResponse =
            WebhookRetrieveResponse.builder()
                .data(
                    WebhookRetrieveResponse.Data.builder()
                        ...
                        .eventFilters(
                            WebhookRetrieveResponse.Data.EventFilters.builder()
                ...
                .error(
                    WebhookRetrieveResponse.Error.builder()
                        .code("code")
                        .details(
                            WebhookRetrieveResponse.Error.Details.builder()
                                .putAdditionalProperty("foo", JsonValue.from(listOf("string")))
                                .build()
                        )
                        .docUrl("doc_url")
                ...
                .meta(
                    WebhookRetrieveResponse.Meta.builder()
        ...
        assertThat(webhookRetrieveResponse.data())
            .contains(
                WebhookRetrieveResponse.Data.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .consecutiveFailures(0)
        ...
        assertThat(webhookRetrieveResponse.error())
            .contains(
                WebhookRetrieveResponse.Error.builder()
                    .code("code")
                    .details(
        ...
        assertThat(webhookRetrieveResponse.meta())
            .contains(
                WebhookRetrieveResponse.Meta.builder()
                    .requestId("request_id")
                    .timestamp(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(webhookRetrieveResponse.success()).contains(true)
    }

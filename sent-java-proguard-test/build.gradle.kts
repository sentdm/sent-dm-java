...
dependencies {
    testImplementation(project(":sent-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../sent-java-core/src/main/resources/META-INF/proguard/sent-java-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../sent-java-core/src/main/resources/META-INF/proguard/sent-java-core.pro",
